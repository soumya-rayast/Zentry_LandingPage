...
const BentoCard = ({ src, title, description, inComingSoon }) => {
    return (
        <div className='relative size-full'>
            <video
                ...
                muted
                autoPlay
                className='absolute left-0 t-0 size-full object-cover object-center'
            />
                ...
                <div className='grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7'>
                    <BentoTilt className='bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2'>
                        <BentoCard
                            ...
                            title={<>zig<b>ma</b>a</>}
                            description="An anime and gaming-inspired NFT collection - the IP primed expansion"
                        />
                    </BentoTilt>
